L.Control.StyledLayerControl = L.Control.Layers.extend({
    ...
    _addItem: function (obj) {
        ...
        //var inputSlider = '<input id="' + obj.name + '" type="range" min="0" max="1" step="0.1" value="1" onchange="updateOpacity(this.value)"></label>';

        label.appendChild(input);
        label.appendChild(name);
        //label.append(inputSlider);
        ...
        if (!groupContainer) {
            ...
            //inputSlider = '<input id="ac' + obj.className + '" type="range" min="0" max="1" step="0.1" value="1" onchange="updateOpacity(this.value)">';
            ...
            groupContainer.innerHTML = inputElement + inputLabel; // + inputSlider;
